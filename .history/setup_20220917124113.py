from webdriver_auto_update import check_driver, obtain_os, get_latest_chromedriver_release
print(obtain_os())
print(get_latest_chromedriver_release())
check_driver(rf'C:\Users\ronyk\OneDrive\Desktop\PROG')
