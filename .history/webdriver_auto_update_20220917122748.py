...
def download_latest_version(version_number, driver_directory):
    """Download latest version of hromedriver to a specified directory.
...
def obtain_os():
    """Obtains operating system based on chromedriver executable supported by from https://chromedriver.chromium.org/
    :return: str"""
